                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">$223-09-05<small
                ...
                <div class="col-xl-3 col-6">
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                <p class="text-mute mt-20 mb-0 font-size-16">Monthlay Sale</p>
                                <h3 class="text-white mb-0 font-weight-500">$9<small
                                        class="text-success"><i class="fa fa-caret-up"></i> USD</small></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">$2023 <small
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">23<small
                                ...
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                         ...
                                         by cach
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-primary-light badge-lg">payd</span>
